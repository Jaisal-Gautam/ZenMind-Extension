...
function DeepFocusCard() {
  ...
  return (
    <div className="w-full bg-page dark:bg-app shadow-sm p-4 sm:p-6 lg:p-8 border border-border-default rounded-md border-t-4 sm:border-t-6 dark:border-t-brand border-t-brand-muted">
      <Card
        icon={<Timer className="size-5 sm:size-6 lg:size-8 text-brand" />}
        heading="Deep Focus"
