  ...
  return (
    <main className="min-h-screen w-full mt-12  p-8 lg:p-4 xl:p-0">
      ...
      <section className="mt-16 flex flex-col md:flex-row  gap-8 justify-between">
        <div className="w-full md:flex-2 border not-last-of-type:border-border-light bg-app shadow-sm rounded-md p-4">
          <DurationSelector />
        </div>
        <div className="w-full md:flex-1 border not-last-of-type:border-border-light bg-app shadow-sm rounded-md p-4">
          <FocusStats focus={focus} overview={overview} />
        </div>
      </section>
      <section className="flex mt-8 flex-col md:flex-row  gap-8 justify-between ">
        <div className="w-full md:flex-2 bg-app border not-last-of-type:border-border-light shadow-sm rounded-md p-4">
          <DailyGoal />
        </div>
        <div className="w-full md:flex-4 border not-last-of-type:border-border-light  bg-app shadow-sm rounded-md ">
          <AudioPlayer />
        </div>
      </section>
    </main>
